...
//IMPORT IMAGE
import Young_Link1 from "../assets/img/Character_Pics/Young_Link_SSBU.png";
...
class Young extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Young_Link/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Young_Link/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Young_Link")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Young_Link/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Young_Link/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Young_Link/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Young_Link/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Young_Link/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Young Link</h1>
                    <div>
                        {this.state.content}
                    </div>
            ...
            <WriteComment character = "Young Link"/>
        </React.Fragment>
          );
    }
}

...
//IMPORT IMAGE
import Corrin1 from "../assets/img/Character_Pics/Corrin_SSBU.png";

//IMPORT COMMENTBOX
import WriteComment from "../components/writeComment";

class Corrin extends Component {
    state = {
        content: "",
        moves: [],
        newMoves: [],
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Corrin/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Corrin/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Corrin")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Corrin/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Corrin/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Corrin/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Corrin/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Corrin/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Corrin</h1>
                    <div>
                        {this.state.content}
                    </div>

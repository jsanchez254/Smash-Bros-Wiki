...
//IMPORT IMAGE
import Piranha_Plant1 from "../assets/img/Character_Pics/Piranha_Plant_SSBU.png";
...
class Plant extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Piranha_Plant/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Piranha_Plant/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Piranha_Plant")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Piranha_Plant/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Piranha_Plant/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Piranha_Plant/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Piranha_Plant/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Piranha_Plant/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Piranha Plant</h1>
                    <div>
                        {this.state.content}
                    </div>
            ...
            <WriteComment character = "Piranha Plant"/>
        </React.Fragment>
          );
    }
}

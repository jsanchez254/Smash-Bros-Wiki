...
//IMPORT IMAGE
import Megaman1 from "../assets/img/Character_Pics/Mega_Man_SSBU.png";

//IMPORT COMMENTBOX
import WriteComment from "../components/writeComment";

class Megaman extends Component {
    state = {
        content: "",
        moves: [],
        newMoves: [],
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Mega_Man/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Mega_Man/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Mega_Man")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Mega_Man/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Mega_Man/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Mega_Man/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Mega_Man/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Mega_Man/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Mega Man</h1>
                    <div>
                        {this.state.content}
                    </div>
            ...
            <WriteComment character = "Mega Man"/>
        </React.Fragment>
          );
    }
}

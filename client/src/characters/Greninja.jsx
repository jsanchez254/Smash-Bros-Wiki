...
//IMPORT IMAGE
import Greninja1 from "../assets/img/Character_Pics/Greninja_SSBU.png";

//IMPORT COMMENTBOX
import WriteComment from "../components/writeComment";

class Greninja extends Component {
    state = {
        content: "",
        moves: [],
        newMoves: [],
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Greninja/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Greninja/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Greninja")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Greninja/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Greninja/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Greninja/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Greninja/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Greninja/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Greninja</h1>
                    <div>
                        {this.state.content}
                    </div>
            ...
            <WriteComment character = "Greninja"/>
        </React.Fragment>
          );
    }
}

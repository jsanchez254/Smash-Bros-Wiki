...
//IMPORT IMAGE
import Samus1 from "../assets/img/Character_Pics/Samus_SSBU.png";

//IMPORT COMMENTBOX
import WriteComment from "../components/writeComment";

class Samus extends Component {
    state = {
        content: "",
        moves: [],
        newMoves: [],
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Samus/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Samus/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Samus")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Samus/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Samus/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Samus/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Samus/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Samus/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Samus</h1>
                    <div>
                        {this.state.content}
                    </div>

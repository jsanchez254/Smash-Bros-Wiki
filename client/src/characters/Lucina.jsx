...
//IMPORT IMAGE
import Lucina1 from "../assets/img/Character_Pics/Lucina_SSBU.png";
...
class Lucina extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Lucina/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Lucina/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Lucina")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Lucina/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Lucina/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Lucina/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Lucina/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Lucina/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Lucina</h1>
                    <div>
                        {this.state.content}
                    </div>

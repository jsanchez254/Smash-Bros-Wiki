...
//IMPORT IMAGE
import Falco1 from "../assets/img/Character_Pics/Falco_SSBU.png";

//IMPORT COMMENTBOX
import WriteComment from "../components/writeComment";

class Falco extends Component {
    state = {
        content: "",
        moves: [],
        newMoves: [],
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Falco/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Falco/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Falco")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Falco/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Falco/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Falco/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Falco/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Falco/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Falco</h1>
                    <div>
                        {this.state.content}
                    </div>

...
//IMPORT IMAGE
import Link1 from "../assets/img/Character_Pics/Link_SSBU.png";
...
class Link extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Link/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Link/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Link/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Link/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Link/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Link/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Link/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Link</h1>
                    <div>
                        {this.state.content}
                    </div>

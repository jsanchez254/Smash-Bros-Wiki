...
//IMPORT IMAGE
import Snake1 from "../assets/img/Character_Pics/Snake_SSBU.png";
...
class Snake extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Snake/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Snake/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Snake")
            .then(res => {
                const content = res.data;
                this.setState({content})
            })

        axios.get("http://localhost:5000/Snake/moves")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Snake/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Snake/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Snake/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Snake/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Snake</h1>
                    <div>
                        {this.state.content}
                    </div>

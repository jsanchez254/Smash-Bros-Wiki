...
//IMPORT IMAGE
import Toon_Link1 from "../assets/img/Character_Pics/Toon_Link_SSBU.png";
...
class Toon extends Component {
    state = {
      ...
      componentDidMount(){
        ...
        axios.get("http://localhost:5000/Toon_Link/getFranchise")
            .then(res => {
                const franchise = res.data;
                this.setState({franchise});
            })

            axios.get("http://localhost:5000/Toon_Link/getGames")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Toon_Link")
            .then(res => {
        ...
        axios.get("http://localhost:5000/Toon_Link/tier")
            .then(res => {
                const tier = res.data;
                this.setState({tier});
            })
        
        axios.get("http://localhost:5000/Toon_Link/class")
            .then(res => {
                const class1 = res.data;
                this.setState({class1});
            })
        
        axios.get("http://localhost:5000/Toon_Link/like")
            .then(res => {
                const like = res.data;
                this.setState({like});
            })

        axios.get("http://localhost:5000/Toon_Link/dislike")
        .then(res => {
        ...
        return (
            ...
            <div className = "columns">
                ...
                <div className = "column is-6 is-offset-1">
                    <h1 className = "charTitle">Toon Link</h1>
                    <div>
                        {this.state.content}
                    </div>
            ...
            <WriteComment character = "Toon Link"/>
        </React.Fragment>
          );
    }
}
